                          ...
                          <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('admin-berita.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                  ...
                                  <textarea class="form-control" id="isi" name="isi" rows="10" style="height: 200px;"></textarea>
                              </div>                                                          
                                <div class="form-group">
                                    <label for="gambar_berita">Gambar Berita:</label>
                                    <input type="file" class="form-control-file" id="gambar_berita" name="gambar_berita" required>
                                </div>
                                <div class="form-group">
